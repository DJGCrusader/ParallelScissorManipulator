...
public:
   ...
   bool IsInitialized( void ){ return GetNetworkRef() != 0; }
...
protected:
   ...
   /// by this node.
   /// @param frame Reference to the CAN frame holding the emergency data.
   ...
   /// called.
   /// @param from Previous node state before the change
