...
*/
/***************************************************************************/
class Trajectory: public RefObj
{
public:
   Trajectory( void ): RefObj( "Trajectory" ){}

   /// Virtual destructor 
   virtual ~Trajectory(){ KillRef(); };
...
*/
/***************************************************************************/
class LinkTrajectory: public RefObj
{
public:
   /// LinkTrajectory default constructor.
   LinkTrajectory( void ): RefObj( "LinkTrajectory" ){}

   /// Virtual destructor 
   virtual ~LinkTrajectory(){ KillRef(); };
