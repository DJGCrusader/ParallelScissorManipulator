 ...
 * This is an internal structure which is part of the CML
 * interface to the Copley CAN card.
 */
typedef struct
{
   int32_t  timeout;
...
#define COPLEYCAN_CANFLG_ERROR         0x00000080   // Message contains error counter info
