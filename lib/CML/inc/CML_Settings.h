...
/// Number of EtherCAT frames that each EtherCAT interface can 
/// keep track of at a time.
#define CML_MAX_ECAT_FRAMES         100

/// Compiler native type to use for 64-bit integer.  
/// Normally this doesn't need to be defined, but if you're getting
/// compiler errors related to the int64 type you can set this
//#define CML_INT64_TYPE              some_type

/// Some C++ compilers support the C99 style stdint.h header which 
/// defines variables of standard sizes.  Uncomment this line to use
/// that header to define the 64-bit integer type.  If this line is
/// uncommented, then CML_INT64_TYPE is ignored.
//#define CML_USE_STDINT
...
/**************************************************
* For gcc, use stdint for 64-bit ints if no other type 
* was specified above.
**************************************************/
#if defined(__GNUC__) && !defined(CML_INT64_TYPE) && !defined(CML_USE_STDINT)
        #define CML_USE_STDINT
#endif
