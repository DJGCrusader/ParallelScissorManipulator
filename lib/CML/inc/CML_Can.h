...
*/
/***************************************************************************/
class CanInterface: public RefObj
{
...
public:
   ...
   /// Return true if the CAN interface supports timestamps on 
   /// received frames.
   /// @return true if timestamps are supported
   virtual bool SupportsTimestamps( void ){ return false; }
