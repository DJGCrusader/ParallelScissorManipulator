...
// Include the stdint header if needed
#if defined(CML_USE_STDINT) || ( !(defined CML_INT64_TYPE) && (__STDC_VERSION__ >= 199901L))
#  include <stdint.h>
#  undef CML_INT64_TYPE
#  define CML_INT64_TYPE int64_t
#endif
...
If this isn't working correctly, check the library configuration
in the file CML_Settings.h
*/
#ifdef CML_INT64_TYPE
typedef CML_INT64_TYPE int64;
#elif defined(WIN32)
typedef __int64 int64;
#else
#  error "Unable to find a suitable 64-bit int type!  See CML_Settings.h"
#endif
