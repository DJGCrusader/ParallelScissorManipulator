 ...
 */
/***************************************************************************/
const Error *CanInterface::SetName( const char *name )
{
   portName = CloneString( name );
   return 0;
}
...
*/
/***************************************************************************/
const Error *CanInterface::Recv( CanFrame &frame, Timeout timeout )
{
...
*/
/***************************************************************************/
const Error *CanInterface::Xmit( CanFrame &frame, Timeout timeout )
{
...
* and return.
**************************************************/
const Error *CanInterface::RecvFrame( CanFrame &frame, Timeout timeout )
{
   Thread::sleep( timeout );
   return &ThreadError::Timeout;
}

const Error *CanInterface::XmitFrame( CanFrame &frame, Timeout timeout )
{
   Thread::sleep( timeout );
   return &ThreadError::Timeout;
}
